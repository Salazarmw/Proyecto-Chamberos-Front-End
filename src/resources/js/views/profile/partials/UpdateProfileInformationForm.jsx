        ...
        <div className="flex flex-col items-center justify-center space-y-4">
          <div className="relative">
            ...
            <label
              ...
              className="absolute bottom-0 right-0 bg-indigo-500 dark:bg-indigo-400 rounded-full p-2 cursor-pointer hover:bg-indigo-600 dark:hover:bg-indigo-500 transition-colors"
            >
              <svg
        ...
        {user && user.user_type === "chambero" && (
          <div>
            ...
            <div className="mt-2 max-h-[200px] overflow-y-auto p-4 border border-gray-300 dark:border-gray-700 rounded-lg [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-indigo-600 [&::-webkit-scrollbar-thumb]:rounded-full dark:[&::-webkit-scrollbar-thumb]:bg-indigo-400">
              <div className="grid grid-cols-2 gap-3">
                {tags.map((tag) => (
                  <label
                    key={tag._id}
                    className="flex items-center space-x-2 p-2 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-md transition-colors"
                  >
                    <input
                      type="checkbox"
                      name="tags"
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
              Selecciona hasta 10 etiquetas que describan tus habilidades y
